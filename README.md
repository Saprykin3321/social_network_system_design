...
Для изображений на год потребуется 3.65 ПТ. Предположим, будем использовать Yandex S3 Cloud. Из расчета 2,1708 руб за ГБ (стандартное хранилище), получаем ~ 8 300 000 руб за год.

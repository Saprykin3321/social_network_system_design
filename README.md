...
Проектирование высоконагруженной Социальной сети для путешественников YetAnotherGram

# Содержание
[1. Требования к системе](#Требования_к_системе)  
[2. Модель данных](#Модель_данных)  
[3. Описание API](#API_запросы)  
[4. Архитектура системы](#Архитектура)  
[5. Расчет нагрузки и трафика](#Расчет_нагрузки_и_трафика)  
[6. Расчет объема хранилища на 1 год](#Расчет_хранилища)  
[7. Расчет количества дисков](#Расчет_дисков)  
[8. Расчет хостов](#Расчет_хостов)    
...
![Context C4](database/database.png)
